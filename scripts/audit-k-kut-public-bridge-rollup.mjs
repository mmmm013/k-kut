...
const audits = [
  ...
  "scripts/audit-pix-kk-batch-01-possible-internal-review-assets.mjs",
  "scripts/audit-pix-kk-batch-01-clean-source-asset-eligibility.mjs",
  "scripts/audit-pix-kk-batch-01-clean-source-review-queue.mjs",
  "scripts/audit-pix-kk-batch-01-provenance-filter.mjs",
  "scripts/audit-pix-kk-batch-01-internal-review-decisions.mjs",
  "scripts/audit-pix-kk-batch-01-review-priority-queue.mjs",
  "scripts/audit-pix-kk-batch-01-quality-triage.mjs",
  "scripts/audit-pix-kk-batch-01-internal-candidates.mjs",
  "scripts/audit-pix-kk-batch-source-catalog.mjs",
  ...
  "scripts/audit-income-fill-sprint-01-theme-audio-discovery.mjs",
  "scripts/audit-income-fill-sprint-01-audio-repair-plan.mjs",
  "scripts/audit-income-fill-sprint-01-quality-triage.mjs",
  ...
  "scripts/audit-thank-you-gratitude-internal-approval-decisions.mjs",
