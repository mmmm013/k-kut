...
if (/\brequired\b/.test(checkboxBlock)) {
  stop("SMS consent checkbox must never be required");
}
if (/defaultChecked|checked=\{true\}/.test(checkboxBlock)) {
...
if (/\.messages\.create|messages\.create|TWILIO_AUTH_TOKEN/.test(route)) {
...
requireText(
  ...
  "no phone retention for declined SMS",
);
