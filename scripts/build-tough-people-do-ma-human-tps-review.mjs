...
function build({ item, outDir }) {
  ...
  const outPath = path.join(outDir, `${item.fileStem}-ma-human-tp-loud-twinkle.mp3`);
  ...
  return {
    ...item,
    displayPix: "Tough People Do — Ma",
    publicArtistAlias: "Ma",
    musicDurationSec,
...
const tp = {
  songStart: 0.668,
  v1End_ch1Start: 46.789,
  ch1End_v2Start: 75.856,
  v2End_ch2Start: 107.793,
  ch2End_bridgeStart: 139.329,
  bridgeEnd_ch3Start: 156.252,
  songEnd: 204.123
};

const outDir = "public/kks/tough-people-do/ma-human-tps-review-v1";

const items = [
  {
    id: "tpd-ma-blk1-v1-human",
    fileStem: "ma-blk1-v1",
  ...
  {
    id: "tpd-ma-blk2-ch1-human",
    fileStem: "ma-blk2-ch1",
  ...
  {
    id: "tpd-ma-blk4-ch2-human",
    fileStem: "ma-blk4-ch2",
  ...
  {
    id: "tpd-ma-blk5-bridge-human",
    fileStem: "ma-blk5-bridge",
  ...
  {
    id: "tpd-ma-blk6-ch3-final-human",
    fileStem: "ma-blk6-ch3-final",
    publicTitle: "Tough People Do",
...
fs.writeFileSync("data/kk-sets/tough-people-do-ma-human-tps-review-v1.json", JSON.stringify({
  title: "Tough People Do — Ma Human TP Review V1",
  displayPix: "Tough People Do — Ma",
  source,
...
<section class="card">
  ...
  <p class="meta">PIX display: Tough People Do — Ma</p>
...
<head>
  <meta charset="utf-8" />
  <title>Tough People Do — Ma Human TP Review V1</title>
  <style>
...
<body>
  <h1>Tough People Do — Ma Human TP Review V1</h1>
  <p class="subtitle">Human TPs locked. No fake sBLKs. Louder Twinkle. Zero delay before Twinkle.</p>

  <section class="study">
    <h2>Full Source Audio</h2>
    <p class="meta">Authority marks: 0.668 / 46.789 / 75.856 / 107.793 / 139.329 / 156.252 / 204.123</p>
...
fs.writeFileSync("/tmp/tough-people-do-ma-human-tps-review-v1.html", html);

console.log("WROTE JSON: data/kk-sets/tough-people-do-ma-human-tps-review-v1.json");
console.log("WROTE HTML: /tmp/tough-people-do-ma-human-tps-review-v1.html");
