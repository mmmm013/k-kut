...
export function KutReviewerWorkbench() {
  ...
  if (!activeItem) return <main className="min-h-screen bg-[#090806] p-8 text-stone-200"><h1 className="text-2xl font-black text-amber-200">TPR · PRE-MADE II REVIEWER</h1><p className="mt-4">No pending governed KUT review items in Supabase.</p>{queueError && <p className="mt-2 text-red-400">{queueError}</p>}</main>;
