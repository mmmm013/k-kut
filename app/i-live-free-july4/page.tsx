  ...
  return (
    <main className="min-h-screen bg-[#07070a] px-5 py-10 text-white">
      <section className="mx-auto max-w-5xl">
        ...
        <h1 className="mt-5 text-5xl font-black tracking-tight">I Live Free</h1>

        <p className="mt-4 max-w-3xl text-lg leading-8 text-white/75">
          Eleven K-KUT moments rebuilt from exact source authority with verified
          digital-silence padding before the Signature Audio Logo.
        </p>
