...
export const SENTIMEANT_THEMES = [
  {
    ...
    keywords: [
      ...
      ["stressed", 3], ["overwhelmed", 3], ["breakup", 3],
      ["broke up", 4], ["dumped", 4], ["comfort", 3],
  ...
  },
  {
    ...
    keywords: [
      ["love you", 4], ["miss you", 4], ["miss them", 4],
  ...
  },
  {
    ...
    keywords: [
      ["best friend", 5], ["friend", 2], ["bestie", 3],
      ["friendship", 3], ["thank you", 4], ["thanks", 3],
      ["grateful", 4], ["gratitude", 4], ["appreciate", 4],
      ["always there", 4], ["supportive", 3], ["made me laugh", 4],
      ["teammate", 2], ["coworker", 2],
    ],
    recommendations: [
...
export function classifySituation({ text, relationship = "anyone", startingFeelingId = "" }) {
  ...
  const rankings = SENTIMEANT_THEMES.map((theme) => {
    ...
    for (const [term, weight] of theme.keywords) {
