export const personalCategories = {
  ...
  wedding: {
    ...
    featuredPackage: {
      ...
      includes: [
        "One bride-preferred song moment from Forever and a Day",
        "Forever and a Day first-dance song moment",
      ...
      notes: [
        ...
        "Wedding Track Pack is a reviewed package and must stay separate from routine $7.99 HUG checkout.",
...
export type PersonalSlug = keyof typeof personalCategories;

export const personalCategoryList = Object.entries(personalCategories).map(
  ([slug, category]) => ({
    slug,
